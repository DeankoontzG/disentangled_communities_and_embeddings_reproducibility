...
if __name__ == "__main__":
    ...
    for nbiter in range(1,NB_ITERATIONS + 1) : 
        for sbm_ratio in np.arange(0.00, 1.10, 0.10):
            ...
            try:
                ...
                print(f"Graph succesfully charged : {G.number_of_nodes()} nœuds et {G.number_of_edges()} liens.")
            except Exception as e:
                print(f"Error when charging graph {path} : {e}")
            ...
            print(f"Done en {duration:.2f} secondes.")
    ...
    duration = end_time - start_time
    print("\n" + "="*50)
    print("EXECUTION TIME FOR ANALYSIS:")
    print("="*50)
    print(f"{duration} secs")

    
    # Results Display : 
    #date_and_time = "17-07-2026_13-49"
